...
var strMapPipes = ",ªh2}-r@vca",
strMapClouds = "(eRAr&¦B),F¤@f2E0u¤¨3eO2^)¸H0¢¥65$U2v*wK0®¥g0",
strMapBushes = "$®5P~fVGzB©;=L¹TMv¸y|F¯KU¯­X^¤7;~6»[", // yui
strMapHills = "&®|R·/V~{¼n|g°=I¯±W_wV¢",
strMapHillsRight = "'®¥S%/¸£|\"n½i°AI¿²Waw_¢",
...
aMapData = [
    ...
    ["b°)HL£r)eJQZgNCY5Dµ4ew3(m¨UI~®xSvsVy|>°­c°IZF.¢",10,1,0,0,1],     // blocks  // yui       [131,11,132,10,133,9,134,8,137,8,138,9,139,10,140,11,145,11,146,10,147,9,148,8,149,8,152,8,153,9,154,10,155,11,178,11,179,10,180,9,181,8,182,7,183,6,184,5,185,4,186,4,195,11]
    [   23,12,-24,1,
        41,12,-4,1,
        52,12,-7,1,
        50,12,-5,3,
