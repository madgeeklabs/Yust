...
var iHeight = 35;
var iScreenScale = 4;
var iQuality = 2;   // 1 = best, 2 = half as many lines, etc.
...
function Sprite(strSprite)
{
    ...
    oSpriteCtr.style.width = 32;
    oSpriteCtr.style.height = 32;
    ...
    this.draw = function(iX, iY, fScale) {
        ...
        oSpriteCtr.style.left = iX - fSpriteSize/2;
        oSpriteCtr.style.top = iY - fSpriteSize/2;

        oImg.style.height = fSpriteSize;

        oSpriteCtr.style.width = fSpriteSize;
        oSpriteCtr.style.height = fSpriteSize;
...
function BGLayer(strImage, iLayerWidth) {
    ...
    oLayer.style.height = 10 * iScreenScale;
    oLayer.style.width = iWidth * iScreenScale;
    ...
    return {
        draw : function(fRotation) {
            ...
            oCanvas1.style.left = Math.round(iLeft1);
            oCanvas2.style.left = Math.round(iLeft2);
        },
        div : oLayer
    }
}
